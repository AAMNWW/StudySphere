...
export function FeatureShowcase() {
  ...
  return (
    ...
    >
      ...
      {/* Tab row — scrolls sideways on narrow screens rather than wrapping
          into a ragged block. */}
          ...
          <div className="mx-auto flex w-max gap-2">
            {FEATURES.map((item) => (
              <button
                ...
                className={cn(
                  "relative flex items-center gap-1.5 rounded-full px-4 py-2 text-sm font-medium whitespace-nowrap transition-colors",
                  active === item.key
                    ? "text-background"
